#!/usr/bin/env python
""" file:   wavelets.py (pyboreholes)
    author: Jess Robertson
            CSIRO Earth Science and Resource Engineering
    email:  jesse.robertson@csiro.au
    date:   Wednesday May 1, 2013

    description: Domaining module of the pyboreholes module.
"""
...
from pyboreholes.domains import SamplingDomain
import pyboreholes.metrics as metrics
...
class WaveletDomain(SamplingDomain):
    ...
    """ Domain class to store continuous wavelet transform data.
        ...
        Arguments:
            ...
            domain - a `pyboreholes.SamplingDomain` instance which contains
    """
